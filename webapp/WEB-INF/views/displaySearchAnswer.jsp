...
/*     height: 70px; */
	...
	function validateForm()
 	{
		...
		//define variables to get the field values
		var answerName = document.getElementById("answer_name").value;
    ...
    function showAnswerTextArea()
    {
    	if(username1!="no")
    	{
	    	...
	    	document.location.href = "loginPostAnswer";
 ...
 $(document).ready(function(){
	 	        ...
	 	        strong.style.fontWeight="bold";
	              ...
	              a3.setAttribute('id', 'questionLabel');
	              a3.setAttribute('href',"#");
	              a3.innerHTML = "${question}";
	              a3.style.color = "#000000";
	              a3.style.fontSize = "1.1em";
	              a3.href="displayAnswers?question=${question}";
	              a3.target="_blank"
				  strong.appendChild(a3);
	 	         ...
	 	         postAnswerButtonDiv.style.marginBottom = "30px";
	 			...
	 			//to display the answers
	 		              ...
	 		              readMoreA.setAttribute('id', 'readMoreA');
	 		              ...
	 		              readMoreA.href = 'javascript:showReadMoreAnswerContent("' + originalAnswer.replace(/"/g, '\\"') + '", "pa", "readMoreA")';
         	              ...
         	              var professionVal = "${professionName}";
	 		              ...
	 		              a1.href="profile?userId=${userId}";
	 					  a1.target="_blank";
	 		              a1.innerHTML = "${fname}"+" "+lastNameVal+professionVal+companyVal;
	 		              a1.style.color = "##F00";
	 		             ...
	 		             var educationVal = "${educationName}";
