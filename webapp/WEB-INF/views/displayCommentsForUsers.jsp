...
<!-- Bootstrap CSS File -->
<link
	href="${pageContext.request.contextPath}/bootstrap-course/new1/lib/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">

<!-- Libraries CSS Files -->
<link
	href="${pageContext.request.contextPath}/bootstrap-course/new1/lib/font-awesome/css/font-awesome.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/bootstrap-course/new1/lib/owlcarousel/owl.carousel.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/bootstrap-course/new1/lib/owlcarousel/owl.theme.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/bootstrap-course/new1/lib/owlcarousel/owl.transitions.min.css"
	rel="stylesheet">

<!-- Main Stylesheet File -->
<link
	href="${pageContext.request.contextPath}/bootstrap-course/new1/css/style.css"
	rel="stylesheet">
...
<script
	src="${pageContext.request.contextPath}/bootstrap-course/new1/lib/jquery/jquery.min.js"></script>

<script src="https://code.jquery.com/ui/1.12.0/jquery-ui.js"></script>

<script
	src="${pageContext.request.contextPath}/bootstrap-course/new1/lib/bootstrap/js/bootstrap.min.js"></script>
...
<script>
	...
	//ends here
	  ...
	  //code for read more comment functionality
 	function showReadMoreCommentContent(originalCommentContent, commentContentId, readMoreId)
 	{
 		if (document.getElementById(readMoreId).innerHTML == "Show More")
 		{
 			document.getElementById(readMoreId).innerHTML = "Show Less";
 			document.getElementById(commentContentId).innerHTML = originalCommentContent;
 		}
 		else if (document.getElementById(readMoreId).innerHTML == "Show Less")
 		{
 			document.getElementById(readMoreId).innerHTML = "Show More";
 			document.getElementById(commentContentId).innerHTML = document.getElementById(commentContentId).innerHTML.substring(0,400)+"..........";
 		}
 	}
	...
	function displayQuestionDiv() {
		...
		if (username1 != "no")
			...
			document.location.href = "loginPostQuestion";
	}
	...
	function displayBlogDiv() {
		...
		if (username1 != "no")
			...
			document.location.href = "loginPostBlog";
	}
	...
	function monkeyPatchAutocomplete() {
		...
		$.ui.autocomplete.prototype._renderItem = function(ul, item) {
			...
			return $("<li></li>").data("item.autocomplete", item).append(
					"<a href='javascript:submitSearchForm()'>" + item.label
							+ "</a>").appendTo(ul);
		};
	}
									...
									.ajax({
										...
										success : function(response) {
											...
											for (var i = 0; i < obj.items.length; i++) {
												...
												console
														.log(obj.items[i].imageFlag);
												if (obj.items[i].imageFlag == "Y")
													image.src = "profilePic?userId="
															+ obj.items[i].userId;
												else
												...
												var profileDiv = document
														.createElement("div");

												var username = document
														.createElement("h1");
												username.setAttribute("id",
														"name");
												username.textContent = obj.items[i].first_name
														+ " "
														+ obj.items[i].last_name;
												...
												var professionTag = document
														.createElement("p");
												professionTag.setAttribute(
														"id", "professionTag")
												professionTag.style.paddingRight = "0.5cm";
												professionTag.style.fontSize = "1.3em";

												var professionTagTextNode = document
														.createTextNode(obj.items[i].profession);
												professionTag
														.appendChild(professionTagTextNode);

												var companyTag = document
														.createElement("p");
												companyTag.setAttribute("id",
														"companyTag")
												companyTag.style.paddingRight = "0.5cm";
												companyTag.style.fontSize = "1.3em";

												var companyTagTextNode = document
														.createTextNode(obj.items[i].company_name);
												companyTag
														.appendChild(companyTagTextNode);

												var educationTag = document
														.createElement("p");
												educationTag.setAttribute("id",
														"educationTag")
												educationTag.style.paddingRight = "0.5cm";
												educationTag.style.fontSize = "1.3em";

												var educationTagTextNode = document
														.createTextNode(obj.items[i].education);
												educationTag
														.appendChild(educationTagTextNode);

												var contactTag = document
														.createElement("p");
												contactTag.setAttribute("id",
														"contactTag")
												...
												contactTag
														.appendChild(contactTagTextNode);

												profileDiv
														.appendChild(professionTag);
												profileDiv
														.appendChild(companyTag);
												profileDiv
														.appendChild(educationTag);
												profileDiv
														.appendChild(contactTag);
							...
							$
									.ajax({
										...
										success : function(response) {
											...
											var labelDivQuestion = document
													.createElement("div");

											var labelDivAnswer = document
													.createElement("div");
											labelDivAnswer.style.marginLeft = "15px";

											var labelDivBlog = document
													.createElement("div");
											labelDivBlog.style.marginLeft = "15px";

											var labelDivComment = document
													.createElement("div");
											labelDivComment.style.marginLeft = "15px";

											//for questions
											var labelQuestion = document
													.createElement("h1");
											labelQuestion.setAttribute("id",
													"labelQ");
											...
											labelDivQuestion
													.appendChild(labelQuestion);
											labelDiv
													.appendChild(labelDivQuestion);

											//for answers
											var labelAnswer = document
													.createElement("h1");
											labelAnswer.setAttribute("id",
													"labelQ");
											...
											labelDivAnswer
													.appendChild(labelAnswer);
											labelDiv
													.appendChild(labelDivAnswer);

											//for blogs
											var blogAnswer = document
													.createElement("h1");
											blogAnswer.setAttribute("id",
													"labelQ");
											...
											labelDivBlog
													.appendChild(blogAnswer);
											labelDiv.appendChild(labelDivBlog);

											//for comments
											var labelComment = document
													.createElement("h1");
											labelComment.setAttribute("id",
													"labelComment");
											...
											labelDivComment
													.appendChild(labelComment);
											labelDiv
													.appendChild(labelDivComment);

											output.appendChild(labelDiv);

											//to display the count of the questions
											var questionsCountDiv = document
													.createElement("div");
											questionsCountDiv.setAttribute(
													"id", "questionsCountDiv");
											questionsCountDiv.style.marginBottom = "30px";
											questionsCountDiv.style.width = "540px";
											questionsCountDiv.style.marginBottom = "20px";
											questionsCountDiv.classList.add(
													'divLineTop',
													'divLineQuestionsCount');

											var questionsCount = document
													.createElement("h1");
											questionsCount.setAttribute("id",
													"questionsCount");
											if (obj.items.length == 1)
												questionsCount.textContent = obj.items.length
														+ " Comment";
											else
												questionsCount.textContent = obj.items.length
														+ " Comments";
											...
											output
													.appendChild(questionsCountDiv);

											questionsCountDiv
													.appendChild(questionsCount);
											for (var i = 0; i < obj.items.length; i++) {
												var newDiv = document
														.createElement("div");
												...
												a.href = "getBlogs?blogTopic="
														+ obj.items[i].blogTopic;
												a.target = "_blank"
									            ...
									            var originalCommentContent = obj.items[i].comment;
									            
									            if(originalCommentContent.length>401)
									          	  var pTagTextNode = document.createTextNode(originalCommentContent.substring(0,401)+"..........");
									            else
									          	  var pTagTextNode = document.createTextNode(originalCommentContent);
									            
									            pTag.appendChild(pTagTextNode);
									            
									            var aDiv = document.createElement("div");
									            aDiv.setAttribute("id","aDivComment");
									            aDiv.style.marginBottom = "10px";
									            
									            var readMoreC = document.createElement('a');
									            readMoreC.setAttribute('id', 'readMoreC'+i);
									            readMoreC.setAttribute('href',"#");
									            readMoreC.innerHTML = "Show More"
									            readMoreC.style.color = "##F00";
									            readMoreC.style.fontSize = "0.9em";
									            readMoreC.style.fontWeight = "bold";
									            readMoreC.style.paddingLeft = "0.5cm";
									            readMoreC.style.paddingBottom = "0.5cm";
									            readMoreC.href = 'javascript:showReadMoreCommentContent("' + originalCommentContent.replace(/"/g, '\\"') + '", "pc"+"'+i+'", "readMoreC"+"'+i+'")';
									            
									            aDiv.appendChild(readMoreC);
												...
												var a1 = document
														.createElement('a');
												a1.href = "profile?userId="
														+ obj.items[i].userId;
												a1.target = "_blank";
												a1.innerHTML = obj.items[i].fname
														+ " "
														+ lastNameVal+professionVal+companyVal;
												a1.style.color = "##F00";
												...
												pTime
														.appendChild(pTimeTextNode);

												var timeDiv = document
														.createElement("div");
							...
							$
									.ajax({
										...
										success : function(response) {
											var obj = JSON.parse(response);
											var output = document
													.getElementById('questionsAndAnswers');
											console.log(obj);
											for (var i = 0; i < obj.items.length; i++) {
												var newDiv = document
														.createElement("div");
												...
												a.style.color = "#000000";
												a.style.fontSize = "0.9em";
												a.href = "displayAnswers?question="
														+ obj.items[i].question_name;
												a.target = "_blank"
												strong.appendChild(a);
												...
												a1.href = "profile?userId="
														+ obj.items[i].userId;
												a1.target = "_blank";
												a1.innerHTML = obj.items[i].first_name
														+ " "
														+lastNameVal+professionVal+companyVal;
												a1.style.color = "##F00";
...
//       channelUrl : 'http://hayageek.com/examples/oauth/facebook/oauth-javascript/channel.html', // Channel File
  ...
  (function(d){
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<ul class="list-inline user-menu pull-right">
								<li id="profile" class="hidden-xs"><a id="profileName"
									href="#"></a></li>
								<li id="register" class="hidden-xs"><i
									class="fa fa-edit text-primary"></i> <a
									href="${pageContext.request.contextPath}/signup"
									class="text-uppercase">Register</a></li>
				...
				<div class="navbar navbar-default">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav" id="main-menu">
							<li class="icon-link"><a
								href="${pageContext.request.contextPath}/show"><i
							...
							<li id="newBlogItem"><a href="javascript:displayBlogDiv()">New
									Blog</a></li>
							<li id="yourcontentDiv" class="dropdown dropdown-mm"><a
								href="#" class="dropdown-toggle" data-toggle="dropdown">Your
						...
						<ul>
							<form:form id="searchForm" name="searchForm" method="post"
								role="form" modelAttribute="topQuestions">
								<div class="col-sm-3 col-md-3">
									<form class="navbar-form" role="search">
										<div class="input-group">
											<input type="text" class="form-control"
												placeholder="Search Question, Answer or Blog"
												id="searchData" name="searchData"
												style="width: 520px; margin-top: 14px">
	...
	<div id="content">
		...
		<div class="testimonials block-contained">
			<div id="main-content" class="row">
				...
				<div id="blogs" class="col-md-6 m-b-lg">
				...
				<div id="questionsAndAnswers" class="col-md-6 m-b-lg">
					<h3 class="block-title">Trending Questions</h3>
				</div>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body" id="blog-content">
								...
								<div class="form">
									<form:form id="blogForm" action="saveBlog" name="blogForm"
										data-toggle="validator" method="post" role="form"
										modelAttribute="blogs" enctype="multipart/form-data">

										<div id="userIdDiv">
											<input type="hidden" name="userIdBlogValue"
												id="userIdBlogValue" />
										</div>
										<div class="form-group">
											<input type="text"
												style="border-style: none; border-color: Transparent"
												class="form-control" name="blogTopic" id="blogTopic"
												placeholder="Enter the blog topic" data-placement="right" />
											<div id="validationBlogTopic"
												style="color: #A52A2A; margin-top: 10px"></div>
										</div>
										<div class="form-group">
											<textarea
												style="border-style: none; border-color: Transparent"
												class="form-control" name="blogContent" id="blogContent"
												rows="20" placeholder="Enter the blog content"
												data-placement="right"></textarea>
											<div id="validationBlogContent"
												style="color: #A52A2A; margin-top: 10px"></div>
										</div>
									</form:form>
								</div>
							...
							<div class="modal-footer">
								<button type="button" class="btn" onClick="submitBlogForm()">Add
									Blog</button>
							</div>
						</div>
					</div>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body" id="question-content">
								<!-- 			          <p>Some text in the modal.</p> -->
								<div class="form">
									<form:form id="questionForm" action="saveQuestion"
										name="questionForm" data-toggle="validator" method="post"
										role="form" modelAttribute="topQuestions"
										enctype="multipart/form-data">

										<div id="userIdDiv">
											<input type="hidden" name="userIdQuestionValue"
												id="userIdQuestionValue" />
										</div>
										<div class="form-group">
											<textarea
												style="border-style: none; border-color: Transparent"
												class="form-control" name="questionName" id="questionName"
												rows="5" placeholder="Write your question"
												data-placement="right"></textarea>
											<div id="validationQuestion"
												style="color: #A52A2A; margin-top: 10px"></div>
										</div>
									</form:form>
								</div>
							...
							<div class="modal-footer">
								<button type="button" class="btn" onClick="submitQuestionForm()">Add
									Question</button>
							</div>
						</div>
					</div>
	...
	<footer id="footer" class="block block-bg-grey-dark"
		data-block-bg-img="${pageContext.request.contextPath}/bootstrap-course/new1/img/bg_footer-map.png"
		...
		<div class="container">
			...
			<div class="row" id="contact">
				...
				<div class="col-md-3">
					<address>
						<strong>Thought Warehouse</strong> <br> <i
							class="fa fa-map-pin fa-fw text-primary"></i> 3300 S Federal St <br>
						<i class="fa fa-phone fa-fw text-primary"></i> 312-567-3000 <br>
						<i class="fa fa-envelope-o fa-fw text-primary"></i>
						apannu@hawk.iit.com <br>
					</address>
				</div>
	...
	<script
		src="${pageContext.request.contextPath}/bootstrap-course/new1/lib/owlcarousel/owl.carousel.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/bootstrap-course/new1/lib/stellar/stellar.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/bootstrap-course/new1/lib/waypoints/waypoints.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/bootstrap-course/new1/lib/counterup/counterup.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/bootstrap-course/new1/contactform/contactform.js"></script>
	<!-- Template Specisifc Custom Javascript File -->
	<script
		src="${pageContext.request.contextPath}/bootstrap-course/new1/js/custom.js"></script>

	<!--Custom scripts demo background & colour switcher - OPTIONAL -->
	<script
		src="${pageContext.request.contextPath}/bootstrap-course/new1/js/color-switcher.js"></script>
