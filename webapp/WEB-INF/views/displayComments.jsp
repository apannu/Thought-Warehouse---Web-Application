...
var mainBlogUserId = "";
 ...
 $(document).ready(function(){
	...
	//manage the search box code
	 ...
	 function getBlogs(){
		//for ajax parameter
		 ...
		 //to view question, answer, blog & comment
		 var userIdParamVal;
		 if(fbName!="no")
			 userIdParamVal = fbUserId;
		 else if(username!="no")
			 userIdParamVal = userId;
      ...
      a7.href="profile?userId="+userIdParamVal;
    ...
    labelAnswer.style.marginTop = "15px";
      ...
      a8.href="displayAnswerPageForUsers?userId="+userIdParamVal;
    ...
    blogAnswer.style.marginTop = "15px";
      ...
      a9.href="displayBlogPageForUsers?userId="+userIdParamVal;
    ...
    //for comments
      ...
      labelComment.style.marginTop = "15px";
        ...
        a10.href="displayCommentPageForUsers?userId="+userIdParamVal;
      ...
      output.appendChild(labelDiv);
           ...
           if(obj.items.length==1)
           	  questionsCount.textContent = obj.items.length+" Comment";
           else 
        	  questionsCount.textContent = obj.items.length+" Comments";
