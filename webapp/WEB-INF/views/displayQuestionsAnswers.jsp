...
/*     height: 70px; */
    ...
    $(document).ready(function() {
    	...
    	//for success div
    	$("#answerSuccessStatusDiv").hide();
    	
    	var temp = '${answerSuccessStatus}';
  		if(temp!="")
  		{
  			console.log(temp);
 			$("#answerSuccessStatusDiv").show();
 			$("#answerSuccessStatusDiv").fadeTo(8000, 500).slideUp(500, function(){
 			    $("#answerSuccessStatusDiv").slideUp(500);
 	     }); 
  		 	$(".alert").alert();
  		}
  		
  	    //for error div
    	$("#answerErrorStatusDiv").hide();
    	
    	var temp = '${answerErrorStatus}';
  		if(temp!="")
  		{
  			console.log(temp);
 			$("#answerErrorStatusDiv").show();
 			$("#answerErrorStatusDiv").fadeTo(8000, 500).slideUp(500, function(){
 			    $("#answerErrorStatusDiv").slideUp(500);
 	     }); 
  		 	$(".alert").alert();
  		}
    ...
    function showAnswerTextArea()
    {
    	if(username1!="no" || fbName!="no")
    	{
    		document.getElementById('answer_name').style.display = "block";
        	document.getElementById('answer_name').setAttribute('placeholder', 'Write your answer');
        	document.getElementById("answer_name").focus();
        	
        	document.getElementById('answerButton').disabled = true;
        	
        	document.getElementById('postAnswerButton').style.display = "block";
    	}
	    else
	    	$('#loginDivModal').modal('show');
    ...
    function submitAnswer()
    {
 	...
 	{
 		$("#answerSuccessStatus").css({
	 		  display: "none",
	 		});
 		
 		$("#answerErrorStatus").css({
	 		  display: "none",
	 		});
		...
		//empty all the validation divs
		document.getElementById("answerValidationDiv").innerHTML = "";

		//define variables to get the field values
		var firstNameValue = document.getElementById("answer_name").value;
		
		//code for first name validation
		if(firstNameValue.length == 0){
			
			document.getElementById("answerValidationDiv").innerHTML = "Please enter something to post your answer.";
			document.getElementById("answerValidationDiv").style.display = "block";
			$("#answer_name").prop('required',true);
			answerFlg = true;
		}
		else
		{
 ...
 $(document).ready(function(){
		 ...
		 form.modelAttribute = "answerForm";
		 form.method = "post";
         ...
         questionarea.setAttribute("id", "question_name");
         questionarea.setAttribute("name", "question_name");
         ...
         answerButtonDiv.setAttribute("id","questionDivButton");
         answerButtonDiv.style.width = "540px";
         ...
         answerButton.style.height = "35px";
         answerButton.innerHTML = '<i class="fa fa-pencil" aria-hidden="true"></i>'+" Answer";
         answerButton.style.marginBottom = "25px";
         answerButton.setAttribute("onClick", 'showAnswerTextArea()');
         
         var answerValidationDiv = document.createElement("div");
         answerValidationDiv.setAttribute("id","answerValidationDiv");
         answerValidationDiv.style.marginBottom = "20px";
         answerValidationDiv.style.display = "none";
         answerValidationDiv.style.color = "#A52A2A";
         
         //code to enable hidden answer text area
         answerButtonDiv.appendChild(answerButton);
         answerButtonDiv.appendChild(form);
         answerButtonDiv.appendChild(answerValidationDiv);
         
         form.appendChild(edge);
         form.appendChild(questionarea);
         form.appendChild(userId1);
         
         var postAnswerButtonDiv = document.createElement("div");
         postAnswerButtonDiv.setAttribute("id","questionDivPostButton");
         postAnswerButtonDiv.style.width = "540px";
         postAnswerButtonDiv.className = 'divLine';
         
         var postAnswerButton = document.createElement("button");
         postAnswerButton.setAttribute("id", "postAnswerButton");
         postAnswerButton.classList.add('btn','btn-primary');
         postAnswerButton.style.width = "80px";
         postAnswerButton.style.height = "35px";
         postAnswerButton.innerHTML = "Submit";
         postAnswerButton.style.marginBottom = "25px";
         postAnswerButton.setAttribute("onClick", 'submitAnswer()');
         postAnswerButton.style.display = "none";
         
         postAnswerButtonDiv.appendChild(postAnswerButton);
         
         //to display the count of answers
         var answerCount = document.createElement("div");
         answerCount.setAttribute("id","answerCount");
         answerCount.style.marginBottom = "25px";
         answerCount.style.width = "540px";
         answerCount.className = 'divLine';
         ...
         a11.innerHTML = "Be the first one to answer";
         a11.style.color = "##F00";
         a11.style.fontSize = "0.9em";
         a11.style.fontWeight = "bold";
         a11.href="javascript:showAnswerTextArea()";
         
         var answerStrong = document.createElement("h1");
         answerStrong.setAttribute("id", "answerCount");
         if(answerCount1==0)
        	 answerStrong.appendChild(a11);
         else if(answerCount1==1)
          	answerStrong.textContent = '${answerCount}'+" Answer";
         else
         	answerStrong.textContent = '${answerCount}'+" Answers";
         answerStrong.style.fontSize = "1.4em";
         
         questionDiv.appendChild(strong);
         answerCount.appendChild(answerStrong);
         ...
         numberOfViews.style.fontSize = "1.4em";
         ...
         output.appendChild(answerButtonDiv);
         output.appendChild(postAnswerButtonDiv);
         output.appendChild(numberOfViewsDiv);
         output.appendChild(answerCount);
		...
		//to display the answers
              ...
              var originalAnswer = temp.items[i].answer_name.replace(/"/g, '\\"');
              ...
              //end of code to handle read more
	              ...
	              var companyVal = temp.items[i].company_name;
	              if(companyVal.length == 0)
	            	  companyVal = "";
	              else
	            	  companyVal = ", "+companyVal;
	              
	              var lastNameVal = temp.items[i].last_name;
				  ...
				  a1.target="_blank";
	              a1.innerHTML = temp.items[i].first_name+" "+lastNameVal+professionVal+companyVal;
	              a1.style.color = "##F00";
      ...
      <div class="testimonials block-contained">
        <div id="main-content" class="row">
          <!--Customer testimonial-->
           <div class="alert alert-success" id="answerSuccessStatusDiv">
		      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
		      ${answerSuccessStatus}
		    </div>
		    
		     <div class="alert alert-danger" id="answerErrorStatusDiv">
		      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
		      ${answerErrorStatus}
		    </div>
