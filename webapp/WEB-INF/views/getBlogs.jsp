...
//     	var userId = "${userId}";
     ...
     $(document).ready(function(){
    	...
    	//to handle error and success message divs.
    	
    	//for success div
    	$("#commentSuccessStatusDiv").hide();
    	
    	var temp = '${commentSuccessStatus}';
  		if(temp!="")
  		{
  			console.log(temp);
 			$("#commentSuccessStatusDiv").show();
 			$("#commentSuccessStatusDiv").fadeTo(8000, 500).slideUp(500, function(){
 			    $("#commentSuccessStatusDiv").slideUp(500);
 	     }); 
  		 	$(".alert").alert();
  		}
  		
  	    //for error div
    	$("#commentErrorStatusDiv").hide();
    	
    	var temp = '${commentErrorStatus}';
  		if(temp!="")
  		{
  			console.log(temp);
 			$("#commentErrorStatusDiv").show();
 			$("#commentErrorStatusDiv").fadeTo(8000, 500).slideUp(500, function(){
 			    $("#commentErrorStatusDiv").slideUp(500);
 	     }); 
  		 	$(".alert").alert();
  		}
    ...
    function showCommentTextArea()
    {
    	if(username1!="no" || fbName!="no")
    	{
        	...
        	document.getElementById('comment').setAttribute('placeholder', 'Write your comment');
    ...
    function submitComment()
    {
 	...
 	{
 		$("#commentSuccessStatusDiv").css({
	 		  display: "none",
	 		});
 		
 		$("#commentErrorStatusDiv").css({
	 		  display: "none",
	 		});
		...
		//empty all the validation divs
		document.getElementById("commentValidationDiv").innerHTML = "";

		//define variables to get the field values
		var firstNameValue = document.getElementById("comment").value;
		
		//code for first name validation
		if(firstNameValue.length == 0){
			
			document.getElementById("commentValidationDiv").innerHTML = "Please enter something to post your comment.";
			document.getElementById("commentValidationDiv").style.display = "block";
 ...
 $(document).ready(function(){
		...
		//to display the question
         ...
         questionDiv.style.width = "540px";
         
         var strong = document.createElement("h4");
         strong.setAttribute("id", "question");
         strong.style.fontWeight="bold";
         strong.textContent = '${blogTopic}';
		 ...
		 displayBlogs();
		   ...
		   function displayBlogs(){
			   	 $.ajax({
			   	  type: "post",
			   	  url: "displayUserInformationForBlogs",
			   	  data: {"blogTopic": '${blogTopic}'},
			   	  cache: false,    
			   	  success: function(response){
			   	   ...
			   	   for (var i=0; i<obj.items.length; i++)
			   	   {
			            ...
			            //start of code to handle read more
			              ...
			              timeDiv.style.marginTop = "41px";
			              timeDiv.style.marginBottom = "-35px";
			             ...
			             //create a form
			     		 ...
			     		 form.modelAttribute = "commentForm";
			     		 form.method = "post";
			     		 
			     		 //answer text area
			     		 var edge = document.createElement("textarea");
			              edge.setAttribute("rows", 8);
			              edge.id = "comment";
			              edge.name = "comment";
			              edge.style.width = "540px";
			              edge.style.marginBottom = "25px";
			              edge.style.display = "none";
			              
			              //hidden question value
			              var questionarea = document.createElement("input");
			              questionarea.setAttribute("id", "blogTopic1");
			              questionarea.setAttribute("name", "blogTopic1");
			              questionarea.value = '${blogTopic}';
			              questionarea.style.display = 'none';
			              
			              //hidden userid value
			              var userId1 = document.createElement("input");
			              userId1.setAttribute("id", "userId");
			              userId1.setAttribute("name", "userId");
			              if(username1!="no")
			              	userId1.value = userId;
			              else if(fbName!="no")
				             userId1.value = fbUserId;
			              userId1.style.display = 'none';
			              
			              //to display the answer button
			              var commentButtonDiv = document.createElement("div");
			              commentButtonDiv.setAttribute("id","commentButtonDiv");
			              commentButtonDiv.style.width = "650px";
			              ...
			              commentButton.innerHTML = '<i class="fa fa-pencil" aria-hidden="true"></i>'+" Comment";
			              commentButton.style.marginBottom = "25px";
			              commentButton.setAttribute("onClick", 'showCommentTextArea()');
			              
			              var blogValidationDiv = document.createElement("div");
			              blogValidationDiv.setAttribute("id","commentValidationDiv");
			              blogValidationDiv.style.marginBottom = "20px";
			              blogValidationDiv.style.display = "none";
			              blogValidationDiv.style.color = "#A52A2A";
			              
			              //code to enable hidden answer text area
			              commentButtonDiv.appendChild(commentButton);
			              commentButtonDiv.appendChild(form);
			              commentButtonDiv.appendChild(blogValidationDiv);
			              
			              form.appendChild(edge);
			              form.appendChild(questionarea);
			              form.appendChild(userId1);
			              
			              var postCommentButtonDiv = document.createElement("div");
			              postCommentButtonDiv.setAttribute("id","postCommentButtonDiv");
			              postCommentButtonDiv.style.width = "540px";
			              postCommentButtonDiv.className = 'divLine';
			              
			              var postCommentButton = document.createElement("button");
			              postCommentButton.setAttribute("id", "postCommentButton");
			              postCommentButton.classList.add('btn','btn-primary');
			              postCommentButton.style.width = "80px";
			              postCommentButton.style.height = "35px";
			              postCommentButton.innerHTML = "Submit";
			              postCommentButton.style.marginBottom = "25px";
			              postCommentButton.setAttribute("onClick", 'submitComment()');
			              postCommentButton.style.display = "none";
			              
			              postCommentButtonDiv.appendChild(postCommentButton);
			              
			              //for number of views
			              var numberOfViewsDiv = document.createElement("div");
			              numberOfViewsDiv.setAttribute("id","numberOfViewsDiv");
			              numberOfViewsDiv.style.marginBottom = "30px";
			              numberOfViewsDiv.style.width = "540px";
			              numberOfViewsDiv.style.marginBottom = "5px";
			              numberOfViewsDiv.className = 'divLine';
			              
			              //to display the count of comments
			              var commentCountDiv = document.createElement("div");
			              commentCountDiv.setAttribute("id","commentCountDiv");
			              commentCountDiv.style.marginBottom = "25px";
			              commentCountDiv.style.width = "540px";
			              commentCountDiv.className = 'divLine';
			              
			              var a11 = document.createElement('a');
			              a11.setAttribute('id', 'questionTag1');
			              a11.setAttribute('href',"#");
			              a11.innerHTML = "Be the first one to comment";
			              a11.style.color = "##F00";
			              a11.style.fontSize = "0.9em";
			              a11.style.fontWeight = "bold";
			              a11.href="javascript:showCommentTextArea()";
			              
			              var commentCount = document.createElement("h1");
			              commentCount.setAttribute("id", "commentCount");
			              if(answerCount1==0)
			            	  commentCount.appendChild(a11);
			              else if(answerCount1==1)
			            	  commentCount.textContent = '${commentCount}'+" Comment";
			              else
			            	  commentCount.textContent = '${commentCount}'+" Comments";
			              commentCount.style.fontSize = "1.3em";
			              
			              var numberOfViews = document.createElement("h1");
			              numberOfViews.setAttribute("id", "numberOfViews");
			              numberOfViews.textContent = "Number of views: "+'${numberOfViews}';
			              numberOfViews.style.fontSize = "1.3em";
			              
			              numberOfViewsDiv.appendChild(numberOfViews);

			              commentCountDiv.appendChild(commentCount);
			              output.appendChild(commentButtonDiv);
			              output.appendChild(postCommentButtonDiv);
			              output.appendChild(numberOfViewsDiv);
			              output.appendChild(commentCountDiv);
			     		...
			     		//to display the comments
			     	              ...
			     	              var pTag = document.createElement("p");
			     	              pTag.setAttribute("id", "pc"+i)
			     	              pTag.style.paddingLeft = "0.5cm";
			     	              pTag.style.paddingRight = "0.5cm";
			     	              pTag.style.paddingBottom = "0.1cm";
			     	              pTag.style.paddingTop = "0.7cm";
			     	              
			     	           //start of code to handle read more
			  		            var originalCommentContent = temp.items[i].comment;
			  		            ...
			  		            //end of code to handle read more
			     	              ...
			     	              var image = document.createElement("img");
			     	              if(temp.items[i].imageFlag=="Y")
			     	            	  image.src = "profilePic?userId="+temp.items[i].userId;
			     	              else
			     	            	  image.src = "${pageContext.request.contextPath}/bootstrap-course/new1/img/no-profile-pic.png";
			     	              image.className = "image-circle";
			     	              
			     	              var a2 = document.createElement('a');
			     	              a2.href="profile?userId="+temp.items[i].userId;
			     				  a2.target="_blank";
			     	              a2.style.color = "#000000";
			     	              ...
			     	              //start of code to handle empty values
				 	              var professionVal = temp.items[i].profession;
				 	              if(professionVal.length == 0)
				 	            	  professionVal = "";
				 	              else
				 	            	  professionVal = ", "+professionVal;
				 	              
				 	              var companyVal = temp.items[i].company;
				 	              if(companyVal.length == 0)
				 	            	  companyVal = "";
				 	              else
				 	            	  companyVal = ", "+companyVal;
				 	              
				 	              var lastNameVal = temp.items[i].lname;
				 	              if(lastNameVal.length == 0)
				 	            	  lastNameVal = "";
				 	              else
				 	            	  lastNameVal = lastNameVal;
			     	              ...
			     	              var a1 = document.createElement('a');
			     	              a1.href="profile?userId="+temp.items[i].userId;
			     				  a1.target="_blank";
			     	              a1.innerHTML = temp.items[i].fname+" "+lastNameVal+professionVal+companyVal;
			     	              a1.style.color = "##F00";
			     	             ...
			     	             var educationVal = temp.items[i].education;
			    	              if(educationVal.length==0)
			    	            	  	educationVal = "Education not provided";
			   	  ...
			   	  error: function(){      
			   	   alert('An error occured while trying to get the user information.');
			   	  }
			   	 });
			   }
        ...
        FB.api('/me', function(response) {
        	...
        	if(fbName!=null)
        	{
        		$.ajax({
                 	...
                 	document.getElementById("userId").value = response1;
                 	mainQuestionUserId = response1;
                 	mainBlogUserId = response1;
                 	mainCommentUserId = response1;
