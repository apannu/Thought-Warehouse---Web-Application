 ...
 $(document).ready(function(){
	...
	//manage the search box code
	 ...
	 function getAnswers(){
      ...
      a7.href="profile?userId="+userIdParam;
    ...
    labelAnswer.style.marginTop = "15px";
     ...
     a8.href="displayAnswerPageForUsers?userId="+userIdParam;
  ...
  //for blogs
    var labelBlog = document.createElement("h1");
    labelBlog.setAttribute("id", "labelBlog");
    labelBlog.style.fontSize = "1.2em";
    labelBlog.style.color = "#ff8000";
    labelBlog.style.fontWeight="bold";
    labelBlog.style.marginTop = "15px";
      
        var a9 = document.createElement('a');
      a9.setAttribute('id', 'ani');
      a9.setAttribute('href',"#");
      a9.innerHTML = "View Blogs";
      a9.href="displayBlogPageForUsers?userId="+userIdParam;
      
      labelBlog.appendChild(a9);
	     labelDivBlog.appendChild(labelBlog);
      ...
      labelComment.style.marginTop = "15px";
        ...
        a10.href="displayCommentPageForUsers?userId="+userIdParam;
 	  ...
 	  success: function(response){
 	   ...
 	   for (var i=0; i<obj.items.length; i++)
 	   {
            ...
            if(obj.items[i].imageFlag=="Y")
          	  ...
          	  image.src = "${pageContext.request.contextPath}/bootstrap-course/new1/img/no-profile-pic.png";
            image.className = "image-circle-small";
