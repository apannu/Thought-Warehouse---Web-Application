    ...
    //for comments
      ...
      output.appendChild(labelDiv);
           ...
           if(obj.items.length==1)
           	  questionsCount.textContent = obj.items.length+" Blog";
           else 
        	  questionsCount.textContent = obj.items.length+" Blogs";
           ...
           questionsCountDiv.appendChild(questionsCount);
	   	   for (var i=0; i<obj.items.length; i++)
	   	   {
	              ...
	              newDiv.style.width = "540px";
	              newDiv.className = "divLineBlogsCount";
	   	 ...
	   	 $.ajax({
	   	  ...
	   	  success: function(response){
	   	   ...
	   	   for (var i=0; i<obj.items.length; i++)
	   	   {
				  ...
				  a1.target="_blank";
	              a1.innerHTML = obj.items[i].first_name+" "+lastNameVal+professionVal+lastNameVal;
	              a1.style.color = "##F00";
